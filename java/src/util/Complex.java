/* from package org.apache.commons.math3.Complex;
...
public class Complex {
    ...
    private static final long serialVersionUID = -6195664516687396621L;
     ...
     * @since 2.0
     */
    public Complex nthRoot(int n) throws Exception  {
        if (n <= 0) {
     ...
     * @since 2.0
     */
    public Complex[] nthRoots(int n) throws Exception  {
